    ...
    this.innerHTML = `
      ...
      <nav class="navbar navbar-expand-lg" id="mainNavbar">
        <div class="container-fluid">
          ...
          <a class="navbar-brand fw-bold text-white" href="${this.currentPWD == "" ? "javascript:void(0)" : "./"}">School Of Computing</a>
          
          <!-- Mobile Header Controls (Right side: Profile Icon + Toggler) -->
